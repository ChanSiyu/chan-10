...
bool Foam::freeRunMotion::read(const dictionary& dict)
{
...
void Foam::freeRunMotion::write(Ostream& os) const
{
    ...
    if (!restraints_.empty())
    {
        ...
        forAll(restraints_, rI)
        {
            ...
            writeEntry(os, "freeRunMotionRestraint", restraintType);
    ...
    if (!constraints_.empty())
    {
        ...
        forAll(constraints_, rI)
        {
            ...
            writeEntry(os, "freeRunMotionConstraint", constraintType);

            constraints_[rI].freeRunMotionConstraint::write(os);
