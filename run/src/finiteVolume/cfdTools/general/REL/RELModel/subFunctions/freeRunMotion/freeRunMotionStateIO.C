...
#include "freeRunMotionState.H"
#include "IOstreams.H"

// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::freeRunMotionState::write(dictionary& dict) const
{
...
void Foam::freeRunMotionState::write(Ostream& os) const
{
...
(
    Istream& is, freeRunMotionState& sDoFRBMS
)
{
    ...
    (
        "Foam::Istream& Foam::operator>>"
        "(Foam::Istream&, Foam::freeRunMotionState&)"
    );
...
(
    Ostream& os,
    const freeRunMotionState& sDoFRBMS
)
{
